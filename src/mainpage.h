 ...
 * @mainpage @c mdcore
 *
 * @section sec_whatis What is mdcore?
 *
 * mdcore is an attempt to construct a general-purpose library containing
 * efficient implementations of the core routines required for Molecular Dynamics
 * simulations on shared-memory parallel architectures.
 *
